...
Group.new('Cursor',       c.none,         c.hue_2_2,  no)
...
Group.new('Operator',       c.hue_2_2,       c.none, no)
...
Group.new('TSConditional',        c.c.hue_3, c.none, no)
...
Group.new('TSException',          c.c.hue_3, c.none, no)
...
Group.new('TSInclude',            c.c.hue_3, c.none, no)
Group.new('TSKeyword',            c.c.hue_3, c.none, no)
Group.new('TSKeywordFunction',    c.c.hue_3, c.none, no)
Group.new('TSKeywordOperator',    c.c.hue_3, c.none, no)
Group.new('TSLabel',              c.hue_2, c.none, no)
Group.new('TSLiteral',            c.hue_6_2, c.none, no)
Group.new('TSMethod',             c.hue_2, c.none, no)
Group.new('TSNamespace',          c.c.hue_3, c.none, no)
...
Group.new('TSRepeat',             c.c.hue_3, c.none, no)
